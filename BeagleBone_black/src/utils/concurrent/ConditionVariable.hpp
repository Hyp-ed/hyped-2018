...
#ifndef BEAGLEBONE_BLACK_UTILS_CONCURRENT_CONDITIONVARIABLE_HPP
#define BEAGLEBONE_BLACK_UTILS_CONCURRENT_CONDITIONVARIABLE_HPP
...
#endif  // BEAGLEBONE_BLACK_UTILS_CONCURRENT_CONDITIONVARIABLE_HPP
